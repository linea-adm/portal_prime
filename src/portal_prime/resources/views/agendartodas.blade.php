...
<body class="antialiased">
    ...
    <div id="topo" class="topo header-bg">
    ...
    <div id="app">
        ...
        <agendartodas :dados-cliente='@json($dadosCliente)' :dados-notas-fiscais='@json($dadosNotasFiscais)'  logout-url="{{ $logout }}"></agendartodas>
    </div>
